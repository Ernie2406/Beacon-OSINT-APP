...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BN14F1pp.js
var router_BN14F1pp_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BEjkhlwi.css";
var APP_NAME = "Beacon — Public Photo Finder";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Public-source OSINT photo search for missing-person and family reunification casework."
			},
			{
				name: "theme-color",
				content: "#101114"
...
var $$splitComponentImporter = () => import("./routes--MJqYYRi.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var Route = createFileRoute("/api/thumb")({ server: { handlers: { GET: async ({ request }) => {
	...
	if (buf.byteLength > 25e5) return new Response("too large", { status: 413 });
...
//#endregion
export { getRouter, router_BN14F1pp_exports as t };
