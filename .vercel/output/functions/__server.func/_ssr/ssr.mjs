...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DpZJVi2Q.mjs");
...
var manifest = {
	"3a028e5c9d1952231f34a54f075ede408332bb395a5fa1799ef1953cf2c5ddb4": {
		functionName: "searchPublicMedia_createServerFn_handler",
		importer: () => import("./public-search-Bfw__v-P.mjs")
	},
	"f1476ea6df29230d93f6dcc0a459e3b39701dee403c7fbd4eb98005fb1c2e2b8": {
		functionName: "inspectPublicUrl_createServerFn_handler",
		importer: () => import("./public-search-Bfw__v-P.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BN14F1pp.mjs").then((n) => n.t),
